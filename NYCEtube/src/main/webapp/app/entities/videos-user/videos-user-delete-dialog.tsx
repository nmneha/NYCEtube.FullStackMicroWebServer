...
import { getEntity, deleteEntity } from './videos-user.reducer';
...
export const VideosDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="nycEtubeApp.videos.delete.question">Are you sure you want to delete this Videos?</ModalBody>
      <ModalFooter>
